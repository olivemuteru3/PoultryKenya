    ...
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <x-input id="phone" class="block mt-1 w-full" type="number" name="phone" :value="old('phone')" autofocus autocomplete="phone" />
            </div>
        ...
        <script>
            function startSpinner() {
                ...
                if (validationErrors.length > 0) {
                    // Do not start the spinner if there are validation errors
                    return;
                }

                buttonText.style.display = "none"; // Hide the button text
                spinnerIcon.style.display = "inline-block"; // Show the spinner icon
            }
        </script>
    </x-authentication-card>
</x-guest-layout>
